(function(g) {
    ...
    var KB4 = function(a) {
                ...
                this.J.G(T, "click", function(C) {
                    return function(r) {
                        var q = C.XK,
                            ...
                            Z = x.sessionData;
                        g.YH(I.api.X()) && I.api.N("web_player_log_click_before_generating_ve_conversion_params") ? (I.api.logClick(I.V[q].element), q = x.ys(), x = {}, g.EK(I.api, x), q = g.pM(q, x), g.Jw(q, I.api, r)) : g.bV(r, I.api, I.D, Z || void 0) && I.api.pT(x.videoId, Z, x.playlistId)
                    }
                }(U));
                this.V.push(e)
            }
        ...
        VaI = function(a, I) {
            if (a.api.X().N("web_player_log_click_before_generating_ve_conversion_params"))
                for (var U = Math.floor(-a.scrollPosition / (a.B + a.L)), e = Math.min(U + a.columns, a.suggestionData.length) - 1; U <= e; U++) a.api.logVisibility(a.V[U].element, I)
        },
        Aeo = function(a) {
        ...
        Maj = function(a) {
            for (var I = 0; I < a.suggestionData.length; I++) {
                ...
                e.update({
                    views_or_author: T,
                    duration: U.isLivePlayback ? "Ao vivo" : U.lengthSeconds ? g.XT(U.lengthSeconds) : "",
                    link: C,
                    hover_title: U.title,
                    title: U.title,
                ...
                r.N("web_player_log_click_before_generating_ve_conversion_params") && (a.api.createServerVe(e.element, e), (U = (U = U.sessionData) && U.itct) && a.api.setTrackingParams(e.element, U))
            }
        ...
        zN = function(a) {
            ...
            U.B ? T.push("no-link") : (U = g.Zq(U), e.href = U, e["aria-label"] = "Acesse o YouTube para pesquisar mais v\u00eddeos");
            var C = new g.F({
                W: "a",
                ww: T,
                S: e,
            ...
            g.E(this, C);
            a.X().B || (this.V = new kAd(a), this.V.KO(this.element), g.E(this, this.V));
        ...
        gz4 = function(a, I) {
            var U = a.api.X(),
                e;
            I.reason && (iff(I.reason) ? e = KB4(g.Lb(I.reason)) : e = g.fu(g.id(I.reason)), a.E9(e, "content"));
            var T;
            I.subreason && (iff(I.subreason) ? T = KB4(g.Lb(I.subreason)) : T = g.fu(g.id(I.subreason)), a.E9(T, "subreason"));
            if (I.proceedButton && I.proceedButton.buttonRenderer) {
                e = a.Ws("ytp-error-content-wrap-subreason");
                I = I.proceedButton.buttonRenderer;
                var C = g.vA("A");
                if (I.text && I.text.simpleText && (T = I.text.simpleText, C.textContent = T, !LB8(e, T) && (!U.B || U.embedsErrorLinks))) {
                    var r;
                    U = (r = g.d(I == null ? void 0 : I.navigationEndpoint, g.Fl)) ==
                        null ? void 0 : r.url;
                    var q;
                    r = (q = g.d(I == null ? void 0 : I.navigationEndpoint, g.Fl)) == null ? void 0 : q.target;
                    U && (C.setAttribute("href", U), a.api.createClientVe(C, a, 178424), a.G(C, "click", function(x) {
                        jRo(a, x, C)
                    }));
        ...
        oz = function(a) {
            ...
            g.F.call(this, {
                ...
                S: {
                    target: I.j,
                    href: "{{url}}",
                    "aria-label": g.ji("Assista em $WEBSITE", {
                        WEBSITE: g.DX(I)
                    }),
            ...
            g.F.call(this, {
                ...
                Z: [{
                    ...
                    Z: [{
                        ...
                        S: {
                            "aria-label": "Indicador de reprodu\u00e7\u00e3o silenciada"
                        },
                        Z: [{
                            W: "div",
        ...
        Bez = function(a) {
            a.watermark || (a.watermark = new oz(a.api), g.E(a, a.watermark), a.watermark.KO(a.bottomButtons, 0), g.KC(a.watermark.element, "ytp-muted-autoplay-watermark", !0), a.V = new g.qq(a.watermark, 0, !0, 100), g.E(a,
                a.V))
        },
        Dd = function(a) {
            g.F.call(this, {
            ...
            this.expandButton = new g.F({
                ...
                AU: this.api.isEmbedsShortsMode() ? "Mais Shorts" : "Mais v\u00eddeos"
            });
            ...
            var U = new g.F({
                ...
                S: {
                    "aria-label": this.api.isEmbedsShortsMode() ? "Ocultar Shorts" : "Ocultar mais v\u00eddeos"
                },
                Z: [{
                    W: "div",
                    T: "ytp-collapse-icon",
            ...
            this.B.G(this.api, "videodatachange",
                this.Qa);
            this.hide()
        },
        vs = function(a) {
        ...
        fkj = function(a) {
            a.V || (a.B = 5E3, a.J = (0, g.w)(), a.V = new g.oj(function() {
                pff(a)
            }, null), pff(a))
        },
        pff = function(a) {
        ...
        GAz = function(a) {
            var I = g.zd8(a.K);
            I !== a.j && (a.j = I, a.U && (a.U.dispose(), a.U = null), a.B && (a.B.dispose(), a.B = null), a.J && (a.J.dispose(), a.J = null), a.L && (a.L.stop(), a.L.dispose(), a.L = null), I && (I = g.O(g.Lh(a.K)), a.K.isEmbedsShortsMode() && (a.J = new g.F({
                W: "div",
                T: "ytp-pause-overlay-backdrop",
                S: {
                    tabIndex: "-1"
                }
            }), g.E(a, a.J), g.w4(a.K, a.J.element, 4), a.L = new g.qq(a.J, 1E3, !1, 100), g.E(a, a.L), a.J.hide()), a.U = new g.F({
                W: "div",
                T: "ytp-pause-overlay-container",
                S: {
                    tabIndex: "-1"
                }
            }), g.E(a, a.U), a.B = new Dd(a.K, I), g.E(a, a.B), a.B.KO(a.U.element), g.w4(a.K, a.U.element,
                4), SRo(a, a.K.getPlayerStateObject())))
        },
        SRo = function(a, I) {
    ...
    g.H.resize = function(a, I) {
        ...
        if (Math.min(a.width, a.height) <= 150 || r === 0 || !U.uj) this.hide();
            ...
            I && n + 100 > I && x > 50 && (n = Math.max(I, 50 / e), q = Math.ceil(a / (e * (n - 100) + this.L)), x = a / q - this.L,
                n = Math.floor(x / e));
    ...
    g.H.onVideoDataChange = function() {
        ...
        a.uc ? this.title.update({
            title: g.ji("Mais v\u00eddeos de $DNI_RELATED_CHANNEL", {
    ...
    zN.prototype.resize = function(a) {
        ...
        this.V && ($fz(this, a), g.KC(this.element, "related-on-error-overlay-visible", !this.V.isHidden()))
    };
    zN.prototype.L = function(a) {
        g.pu.prototype.L.call(this, a);
        var I = g.O(this.api.getVideoData());
        if (I.zW || I.playerErrorMessageRenderer)(a = I.zW) ? gz4(this, a) : I.playerErrorMessageRenderer && gz4(this, I.playerErrorMessageRenderer);
        else {
            var U;
            a.IM && (I.a_ ? iff(I.a_) ? U = g.Lb(I.a_) : U = g.fu(g.id(I.a_)) : U = g.fu(a.IM), this.E9(U, "subreason"))
        }
    };
    g.u(cem, g.F);
    g.H = cem.prototype;
    g.H.onVideoDataChange = function() {
        var a = g.O(this.api.getVideoData()),
            I = JeD(),
            U = 96714;
        g.r4(a) ? (I = usz(), U = 216165, g.x5(this.element, "ytp-music-impression-link")) : g.ta(this.element, "ytp-music-impression-link");
    ...
    g.H.Oi = function() {
        ...
        I = I.B;
        e || C || U || T || I || this.api.isEmbedsShortsMode() || !a.videoId ? (this.hide(), this.api.logVisibility(this.element, !1)) : (a = WBG(this), this.updateValue("url", a), this.show())
    };
    ...
    hI.prototype.UK = function() {
        ...
        !this.api.MV() || g.Q(a, 2) && g.OK(this.api) || g.Q(a, 64) ? (this.api.logVisibility(this.V, !1), this.api.logVisibility(this.forwardButton, !1), this.hide()) : (this.show(), this.api.logVisibility(this.V, !0), this.api.logVisibility(this.forwardButton, !0))
    };
    ...
    Np.prototype.B = function() {
        ...
        !I.mutedAutoplay || I.limitedPlaybackDurationInSeconds === 0 && I.endSeconds === 0 && I.mutedAutoplayDurationMode === 2 || (g.Q(a, 2) && !this.gF ? (this.show(), this.V || (this.V = new g.X6(this.api), g.E(this, this.V), this.V.KO(this.J, 0), this.V.show()), a = g.O(this.api.getVideoData()), this.updateValue("text",
            a.RB), g.KC(this.element, "ytp-muted-autoplay-show-end-panel", !0), this.api.logVisibility(this.element, this.gF), this.api.s9("onMutedAutoplayEnds")) : this.hide())
    };
    ...
    g.H.onVideoDataChange = function() {
        ...
        var I = g.O(this.api.getVideoData());
        I.videoId && !a.B ? (a = this.api.getVideoUrl(!0, !1, !1, !0), this.updateValue("url", a), this.V || (this.V = this.listen("click", this.onClick))) : this.V && (this.updateValue("url", null), this.YY(this.V), this.V = null);
        a = JeD();
        var U = 76758;
    ...
    g.H.Oc = function() {
        var a = this.api.getPlayerStateObject();
        !g.O(this.api.getVideoData()).mutedAutoplay || g.Q(a, 2) ? this.hide() : this.gF || (g.F.prototype.show.call(this), this.api.logVisibility(this.element, this.gF))
    };
    g.H.Dnm = function() {
        this.V && this.V.hide()
    };
    ...
    Dd.prototype.Qa = function() {
        var a = this.api.getPlayerStateObject();
        g.Q(a, 1) || g.Q(a, 16) || g.Q(a, 32) || (!g.Q(a, 4) || g.Q(a, 2) || g.Q(a, 1024) ? (this.L || this.api.logVisibility(this.element, !1), this.fade.hide()) : this.V.hasSuggestions() && (this.L || (g.x5(this.api.getRootNode(), "ytp-expand-pause-overlay"), g.N0(this.V), this.V.show(), this.api.logVisibility(this.element, !0)), this.fade.show()))
    };
    g.u(vs, g.F);
    ...
    g.H.create = function() {
        var a = this.K.X(),
            I = g.Lh(this.K),
            U, e = (U = this.K.getVideoData()) == null ? void 0 : U.clientPlaybackNonce;
        e && g.z5({
            clientPlaybackNonce: e
        });
        a.i5 && !a.disableOrganicUi && GAz(this);
        var T;
        (T = a.getWebPlayerContextConfig()) != null && T.embedsEnableEmc3ds || (this.D = new PHG(this.K), g.E(this, this.D), g.w4(this.K, this.D.element, 4), this.gw = new Np(this.K), g.E(this, this.gw), g.w4(this.K, this.gw.element, 4));
        a.L4 && (this.watermark = new oz(this.K), g.E(this, this.watermark), g.w4(this.K, this.watermark.element, 8));
        I && !a.disableOrganicUi && (this.Y = new cem(this.K, I), g.E(this, this.Y), g.w4(this.K, this.Y.element, 8), this.K.isMutedByEmbedsMutedAutoplay() && (this.onMutedAutoplayStarts(), this.Y.hide()));
        a.L && !a.disableOrganicUi && (this.Va = new hI(this.K), g.E(this, this.Va), g.w4(this.K, this.Va.element, 4));
        ...
        this.V.G(this.K, "onMutedAutoplayStarts",
        ...
        if (this.C = g.bR(g.Fw(a))) this.countdownTimer = new vs(this.K), g.E(this, this.countdownTimer), g.w4(this.K, this.countdownTimer.element, 4), this.countdownTimer.hide(), this.V.G(this.K, g.ZW("embeds"), this.onCueRangeEnter), this.V.G(this.K, g.tS("embeds"), this.onCueRangeExit);
    ...
    g.H.onCueRangeEnter = function(a) {
        a.getId() === "countdown timer" && this.countdownTimer && (this.countdownTimer.show(), fkj(this.countdownTimer))
    };
    g.H.onCueRangeExit = function(a) {
        a.getId() === "countdown timer" && this.countdownTimer && (this.countdownTimer.stopTimer(), this.countdownTimer.hide())
    };
    g.H.jj = function() {
    ...
    g.H.eM = function(a) {
        g.Q(a, 128) ? (this.Xf || (this.Xf = new zN(this.K), g.E(this, this.Xf), g.w4(this.K, this.Xf.element, 4)), this.Xf.L(a.VR), this.Xf.show(), g.x5(this.K.getRootNode(), "ytp-embed-error")) : this.Xf && (this.Xf.dispose(), this.Xf = null, g.ta(this.K.getRootNode(), "ytp-embed-error"));
        if (this.countdownTimer && this.countdownTimer.V)
            if (g.Q(a, 64)) this.countdownTimer.hide(), this.countdownTimer.stopTimer();
            else if (a.isPaused()) {
            var I = this.countdownTimer;
            I.L || (I.L = !0, I.Y = (0, g.w)())
        } else a.isPlaying() && this.countdownTimer.L &&
            (I = this.countdownTimer, I.L && (I.J += (0, g.w)() - I.Y, I.L = !1, pff(I)));
        SRo(this, a)
    };
    ...
    g.H.onVideoDataChange = function(a, I) {
        ...
        U && (this.pL = I.videoId, this.countdownTimer && (this.countdownTimer.show(), this.countdownTimer.hide()), this.C && (this.K.HE("embeds"), I.isAd() || I.limitedPlaybackDurationInSeconds < 5 || g.y7(this.K) || (I = Math.max((I.startSeconds + I.limitedPlaybackDurationInSeconds -
            5) * 1E3, 0), I = new g.qA(I, I + 5E3, {
            id: "countdown timer",
            namespace: "embeds"
        }), this.K.xw([I]))), this.K.X().i5 && !this.K.X().disableOrganicUi && (YRj(this), GAz(this)));
